...
os.environ["OPENAI_API_BASE"] = "https://api.aiguoguo199.com/v1"
import openai

# openai.api = openai.OpenAIAPI(api_base="https://api.aiguoguo199.com/v1")
...
def main():
    ...
    logging.basicConfig(
        ...
        handlers=[logging.StreamHandler(ColorPrint()),
                  logging.FileHandler(os.path.join(log_dir, f"{query_idx}.log"), mode='w', encoding='utf-8')],
    )
    ...
    scopes = list(
        raw_api_spec['components']['securitySchemes']['oauth_2_0']['flows']['authorizationCode']['scopes'].keys())
    ...
    rest_gpt = RestGPT(llm, api_spec=api_spec, scenario='spotify', requests_wrapper=requests_wrapper,
                       simple_parser=False)
